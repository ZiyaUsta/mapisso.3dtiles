...
public class GLTF extends GlTFProperty {
	...
	/**
	 * Names of glTF extensions required to properly load this asset. (optional)<br>
	 * Minimum number of items: 1<br>
	 * Array elements:<br>
	 * &nbsp;&nbsp;The elements of this array (optional)
	 * 
	 ...
	 * Minimum number of items: 1<br>
	 * Array elements:<br>
	 * &nbsp;&nbsp;A typed view into a bufferView. A bufferView contains raw binary
	 ...
	 * attribute in a buffer. (optional)
	 * 
	 */
	 ...
	 * Minimum number of items: 1<br>
	 * Array elements:<br>
	 * &nbsp;&nbsp;A view into a buffer generally representing a subset of the
	 * buffer. (optional)
	 * 
	 */
	 ...
	 * transform to place the camera in the scene. (optional)
	 * 
	 */
	 ...
	 * Minimum number of items: 1<br>
	 * Array elements:<br>
	 * &nbsp;&nbsp;Image data used to create a texture. Image can be referenced by
	 * URI or `bufferView` index. `mimeType` is required in the latter case.
	 * (optional)
	 * 
	 */
	 ...
	 * A node's transform places the mesh in the scene. (optional)
	 * 
	 */
	...
	public GLTF setNullBufferUri(GLTF gltf) {

		for (int i = 0; i < gltf.buffers.size(); i++) {

			Buffer tempBuffer = gltf.buffers.get(i);
			tempBuffer.setUri(null);

			gltf.buffers.remove(i);
			gltf.buffers.add(i, tempBuffer);
	...
	public GLTF(List<Accessor> accessors, Asset asset, List<Buffer> buffers, List<BufferView> bufferViews,
			List<Material> materials, List<Mesh> meshes, List<Node> nodes, Integer scene, List<Scene> scenes,
			List<String> extensionsRequired, List<String> extensionsUsed) {
	 ...
	 *            The extensionsUsed to set
	 * @throws IllegalArgumentException
	 *             If the given value does not meet the given constraints
	 * 
	 */
	...
	/**
	 * Add the given extensionsUsed. The extensionsUsed of this instance will be
	 * replaced with a list that contains all previous elements, and additionally
	 * the new element.
	 * 
	 * @param element
	 *            The element
	...
	/**
	 * Remove the given extensionsUsed. The extensionsUsed of this instance will be
	 * replaced with a list that contains all previous elements, except for the
	 * removed one.<br>
	...
	/**
	 * Add the given extensionsRequired. The extensionsRequired of this instance
	...
	/**
	 * Remove the given extensionsRequired. The extensionsRequired of this instance
	 * will be replaced with a list that contains all previous elements, except for
	 * the removed one.<br>
	 * If this new list would be empty, then it will be set to <code>null</code>.
	 * 
	 * @param element
	...
	/**
	 * Add the given accessors. The accessors of this instance will be replaced with
	 * a list that contains all previous elements, and additionally the new element.
	 * 
	 * @param element
	 *            The element
	 * @throws NullPointerException
	...
	/**
	 * Remove the given accessors. The accessors of this instance will be replaced
	 * with a list that contains all previous elements, except for the removed
	 * one.<br>
	 * If this new list would be empty, then it will be set to <code>null</code>.
	 * 
	 * @param element
	...
	/**
	 * Add the given animations. The animations of this instance will be replaced
	 * with a list that contains all previous elements, and additionally the new
	 * element.
	 * 
	 * @param element
	 *            The element
	...
	/**
	 * Remove the given animations. The animations of this instance will be replaced
	 * with a list that contains all previous elements, except for the removed
	 * one.<br>
	 * If this new list would be empty, then it will be set to <code>null</code>.
	 * 
	...
	/**
	 * Add the given buffers. The buffers of this instance will be replaced with a
	 * list that contains all previous elements, and additionally the new element.
	 * 
	 * @param element
	 *            The element
	 * @throws NullPointerException
	...
	/**
	 * Remove the given buffers. The buffers of this instance will be replaced with
	 * a list that contains all previous elements, except for the removed one.<br>
	 * If this new list would be empty, then it will be set to <code>null</code>.
	 * 
	 * @param element
	 *            The element
	...
	/**
	 * Add the given bufferViews. The bufferViews of this instance will be replaced
	 * with a list that contains all previous elements, and additionally the new
	 * element.
	 * 
	 * @param element
	...
	/**
	 * Add the given cameras. The cameras of this instance will be replaced with a
	 * list that contains all previous elements, and additionally the new element.
	 * 
	 * @param element
	 *            The element
	...
	/**
	 * Remove the given cameras. The cameras of this instance will be replaced with
	 * a list that contains all previous elements, except for the removed one.<br>
	 * If this new list would be empty, then it will be set to <code>null</code>.
	 * 
	 * @param element
	...
	/**
	 * Add the given images. The images of this instance will be replaced with a
	 * list that contains all previous elements, and additionally the new element.
	 * 
	 * @param element
	 *            The element
	...
	/**
	 * Remove the given images. The images of this instance will be replaced with a
	 * list that contains all previous elements, except for the removed one.<br>
	 * If this new list would be empty, then it will be set to <code>null</code>.
	 * 
	 * @param element
	 *            The element
	...
	/**
	 * Add the given materials. The materials of this instance will be replaced with
	 * a list that contains all previous elements, and additionally the new element.
	 * 
	 * @param element
	 *            The element
	...
	/**
	 * Remove the given materials. The materials of this instance will be replaced
	 * with a list that contains all previous elements, except for the removed
	 * one.<br>
	 * If this new list would be empty, then it will be set to <code>null</code>.
	 * 
	...
	/**
	 * Add the given meshes. The meshes of this instance will be replaced with a
	 * list that contains all previous elements, and additionally the new element.
	 * 
	 * @param element
	 *            The element
	...
	/**
	 * Remove the given meshes. The meshes of this instance will be replaced with a
	 * list that contains all previous elements, except for the removed one.<br>
	 * If this new list would be empty, then it will be set to <code>null</code>.
	 * 
	 * @param element
	...
	/**
	 * Add the given nodes. The nodes of this instance will be replaced with a list
	 * that contains all previous elements, and additionally the new element.
	 * 
	 * @param element
	 *            The element
	 * @throws NullPointerException
	...
	/**
	 * Remove the given nodes. The nodes of this instance will be replaced with a
	 * list that contains all previous elements, except for the removed one.<br>
	 * If this new list would be empty, then it will be set to <code>null</code>.
	 * 
	 * @param element
	...
	/**
	 * Add the given samplers. The samplers of this instance will be replaced with a
	 * list that contains all previous elements, and additionally the new element.
	 * 
	 * @param element
	 *            The element
	...
	/**
	 * Remove the given samplers. The samplers of this instance will be replaced
	 * with a list that contains all previous elements, except for the removed
	 * one.<br>
	 * If this new list would be empty, then it will be set to <code>null</code>.
	 * 
	...
	/**
	 * Add the given scenes. The scenes of this instance will be replaced with a
	 * list that contains all previous elements, and additionally the new element.
	 * 
	 * @param element
	 *            The element
	...
	/**
	 * Remove the given scenes. The scenes of this instance will be replaced with a
	 * list that contains all previous elements, except for the removed one.<br>
	 * If this new list would be empty, then it will be set to <code>null</code>.
	 * 
	 * @param element
	...
	/**
	 * Add the given skins. The skins of this instance will be replaced with a list
	 * that contains all previous elements, and additionally the new element.
	 * 
	 * @param element
	 *            The element
	...
	/**
	 * Remove the given skins. The skins of this instance will be replaced with a
	 * list that contains all previous elements, except for the removed one.<br>
	 * If this new list would be empty, then it will be set to <code>null</code>.
	 * 
	 * @param element
	...
	/**
	 * Add the given textures. The textures of this instance will be replaced with a
	 * list that contains all previous elements, and additionally the new element.
	 * 
	 * @param element
	 *            The element
	...
	/**
	 * Remove the given textures. The textures of this instance will be replaced
	 * with a list that contains all previous elements, except for the removed
	 * one.<br>
	 * If this new list would be empty, then it will be set to <code>null</code>.
	 * 
